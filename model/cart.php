<?php
    ...
    function viewcart($del) {
          // vìđể khung này trong function nên nó không hiểu, phải khai báo global $img_path
        $tong=0;
        $i=0;
        if($del==1) {
    ...
    function insert_cart($img,$name,$price,$soluong,$thanhtien,$idbill) {
        $sql="insert into cart(img,name,price,soluong,thanhtien,idbill) 
        values('$img','$name','$price','$soluong','$thanhtien','$idbill')"; 
        //đây là phần được lấy từ index.php ở case adddm
    ...
    function loadall_bill($kyw="",$iduser=0) { 
        ...
        $listbill_ad=pdo_query($sql); 
        return $listbill_ad;  
    }
    function loadall_bill_mydh($iduser) { 
    ...
    function loadall_thongke() {
        ...
        $listtk=pdo_query($sql);  // này đặt tên $bill
        return $listtk;  
    }
