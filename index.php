<?php
    ...
    $spnew = loadall_sanpham_home();    //khi đã lấy hàm này từ bên sanpham.php(model) thì sang home bỏ vào
    $dsdm = loadall_danhmuc();
    $dstop10 = loadall_sanpham_top10(); //  view ở trong home
        ...
        switch ($act) {
            ...
            case 'dangnhap':
                if(isset($_POST['dangnhap'])&&($_POST['dangnhap'])) {
                    ...
                    if(is_array($checkuser)) {
                        ...
                        header('Location: index.php');  // 1này là load lại trang(mới,  trang gì cũng được), còn include là chèn trang
            ...
            case 'delcart':
                if(isset($_GET['idcart'])) {
                    array_splice($_SESSION['mycart'],$_GET['idcart'],1,); 
                     //  xóa từng cái--cái đầu là xóa trong mảng, thứ 2 là vị trí, thứ 3 là bao nhiêu phần tử
                } else {
                    $_SESSION['mycart']=[];     // n xóa tất cả, làm trống giỏ hàng
                }  
                include "view/cart/viewcart.php";
            ...
            case 'billconfirm':
                ...
                if(isset($_POST['dongydathang'])&&($_POST['dongydathang'])) {
                    ...
                    //insert into (bảng)cart: $_SESSION['mycart'] & idbill --(lấy dữ liệu từ session với cái session['mycart']) và cái idbill 
                    
                    foreach ($_SESSION['mycart'] as $cart) {
                        $sanpham=loadone_sanpham($cart[0]);
                        $soluong=$sanpham['soluong']-$cart[4];
                        update_soluong($cart[0],$soluong);
                        insert_cart($cart[0],$cart[1],$cart[3],$cart[4],$cart[5],$idbill); 
                    }
                    //tạo xong mua rồi thì xóa session 
                    $_SESSION['mycart']=[];     
                }
