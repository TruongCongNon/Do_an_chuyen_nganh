...
<div class="row">
    ...
    <div class="row frmcontent">
        <form action="index.php?act=updatebill" method="post">
            ...
            <div class="row mb10">
                Mã đơn hàng<br>
                <input type="text" value="<?= $mabill, $bill['id'] ?>" readonly>

                <div class="row mb10">
                    Khách hàng<br>
                    <input type="text" value="<?= trim($bill_name) ?>" readonly>
                </div>

                <div class="row mb10">
                    Số lượng mặt hàng<br>
                    <input type="text" value="<?= trim($countsp) ?>" readonly>
                </div>
                <div class="row mb10">
                    Giá trị đơn hàng<br>
                    <input type="text" value="<?= trim($format_total) ?>" readonly>
                </div>
                <div class="row mb10">
                    Ngày đặt hàng<br>
                    <input type="text" value="<?= trim($ngaydathang) ?>" readonly>
                    <div class="row mb10">
